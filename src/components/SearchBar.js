...
class SearchBar extends React.Component {
    ...
    render(){
        ...
        const first = searchResults.length ? JSON.stringify(searchResults[Object.keys(searchResults)[0]]) : ''
        return (
           <div className="search">
                <input type="text" data-item={first} ref={this.queryRef} onKeyDown={this.handleKeyDown} onChange={this.searchIngredients} className="search-ingredient" placeholder="Search ingredient"></input>
